...
if __name__ == "__main__":
    ...
    movEnroque = chess.map(lambda line: (line[11], line[14]))


    #(cantidad de enroques, cantidad de eventos distintos)
    nmovEnroque = movEnroque.aggregateByKey((0.0, 0), \
    ...
    percentagemovEnroque = nmovEnroque.mapValues(lambda tup2n: tup2n[0]/tup2n[1]*100)

    cpercentagemovEnroque = percentagemovEnroque.coalesce(1)

    cpercentagemovEnroque.saveAsTextFile(fileout)
